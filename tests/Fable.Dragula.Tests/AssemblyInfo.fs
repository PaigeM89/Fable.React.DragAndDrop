...
[<assembly: AssemblyTitleAttribute("Fable.Dragula.Tests")>]
[<assembly: AssemblyProductAttribute("Fable.Dragula")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Fable.Dragula.Tests"
    let [<Literal>] AssemblyProduct = "Fable.Dragula"
